...
class ToDoAssignUserNotificationEvent extends AbstractUserNotificationEvent {
	...
	public function getMessage() {
		return $this->getLanguage()->getDynamicVariable('wcf.toDo.notification.assign.message', [
	...
	public function getEmailMessage($notificationType = 'instant') {
		return $this->getLanguage()->getDynamicVariable('wcf.toDo.notification.assign.mail', [
			'todo' => $this->userNotificationObject->object,
			'author' => $this->author
		]);
	}
